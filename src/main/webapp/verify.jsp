                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <h1 class="text-xxl text-primary text-center">Verify it!</h1>
                            <div class="details">
                                <h3>We have sent an activation on your email. Kindly click on that link to verify your account first.</h3>
                            	<p>If not received under 5 minutes, <a href="resendCode?email=<%=email%>">Click</a> here again to resend.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
