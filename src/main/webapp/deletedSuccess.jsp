...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="1;url=https://imdbdemo-imdbdemo.rhcloud.com/home" />
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <h1 class="text-xxl text-primary text-center">Successfully Deleted!</h1>
                            <div class="details">
                                <p>We're redirecting this page to home within 2 seconds, If not <a href="index">click</a> here.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
