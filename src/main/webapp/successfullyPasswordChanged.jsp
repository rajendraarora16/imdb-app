                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <h1 class="text-xxl text-primary text-center">Successfully Changed!</h1>
                            <div class="details">
                                <h3>We have successfully changed your password, Kindly go back and <a href="login">login</a> your account with new password.</h3>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
