...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Type your new password here</title>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <h1 class="text-xxl text-primary text-center">Type new password!</h1>
                            <div class="details">
                                <h3>Type your new password here, Next time remember it!</h3>
                            	<form action="changePasswordProcess" method="post">
                                    ...
                                    <input type="hidden" value=<%=passCode%> name="passCode" />
